...
// SQL to fetch books specific to the logged-in user
$sql = "SELECT title, author, username, issue_date FROM books WHERE username = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $user);  // 's' is for string, for username
$stmt->execute();
